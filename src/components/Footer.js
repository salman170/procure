    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
          class  <a className="text-gray-600 hover:text-gray-800" href='/about'>Name=First Link</a>
          </li>
          <li>
          class  <a className="text-gray-600 hover:text-gray-800" href='/about'>Name=Second Link</a>
          </li>
          <li>
          class  <a className="text-gray-600 hover:text-gray-800"href='/about'>Name=Third Link</a>
          </li>
          <li>
          class  <a className="text-gray-600 hover:text-gray-800"href='/about'>Name=Fourth Link</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">

          ...
          <div className='flex flex-wrap -m-4 '>
            ...
            <div className='p-4 xl:w-1/4 md:w-1/2 w-full '>
              <div className='h-full p-6 rounded-lg border-2 border-gray-300 hover:border-indigo-500 flex flex-col  overflow-hidden shadow-lg shadow-indigo-500/50'>
                ...
                <div className='flex flex-col justify-between h-full'>
                  <div>
                    <h3 className='text-lg px-1'>
                      From requisition to invoice payment, ProcureN handles the
                      full procure-to-pay process and gives complete visibility
                      of the progress of your purchase orders at all times.
                      Buyers can track the status of their requisition.
                    </h3>
                  </div>
                  <div>
                    <button className='flex items-center  text-white bg-indigo-500 border-0  py-2 px-4 w-full focus:outline-none hover:bg-indigo-600 rounded'>
            ...
            <div className='h-full p-6 rounded-lg border-2 border-gray-300 hover:border-indigo-500 flex flex-col overflow-hidden shadow-lg shadow-indigo-500/50'>
                ...
                <div className='flex flex-col justify-between h-full'>
                  <div>
                    <h3 className='text-lg px-1'>
                      Buyers can track the status of their requisition - from
                      submission through multi-stage approval, through flipping
                      into a purchase order, submission to the supplier,
                      acknowledgement by the supplier, to advanced shipping
            ...
            <div className='p-4 xl:w-1/4 md:w-1/2 w-full '>
              <div className='h-full p-6 rounded-lg border-2 border-gray-300 hover:border-indigo-500 flex flex-col overflow-hidden shadow-lg shadow-indigo-500/50'>
                ...
                <div className='flex flex-col justify-between h-full'>
                  <div>
                    <h3 className='text-lg px-1'>
                      An application that automates business processes and
                      provides insights and internal controls, drawing on a
                      central database that collects inputs from departments
                      including accounting, manufacturing, supply chain
